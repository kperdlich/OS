...
static const ADS::size_t VGA_WIDTH = 80;
static const ADS::size_t VGA_HEIGHT = 25;

ADS::size_t terminal_row;
ADS::size_t terminal_column;
...
void terminal_putentryat(char c, uint8_t color, ADS::size_t x, ADS::size_t y)
{
    const ADS::size_t index = y * VGA_WIDTH + x;
...
void terminal_write(const char* data, ADS::size_t size)
{
